...
<body>
      <div class="container w-75 mx-4 my-4 p-3">
            ...
            <form action="product.php" method="POST">
                <p><label for="intitule">Intitule</label><input type="text" name="intitule" id="intitule" class="form-control"/></p>


                <p><label for="prix">Prix</label><input type="number" step="0.001" name="prix" id="prix" class="form-control"/></p>
